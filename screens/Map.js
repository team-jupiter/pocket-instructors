...
let socket = io.connect('http://a0db5c524351.ngrok.io');
    ...
    if (currentInsTriggerUseEffect !== currentInsTriggerForLoop) {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        newObjToPush.attack =
          ...
          Math.floor(0.8 * allInstructors[randomInstructorNumber].maxAttack);
        newObjToPush.defense =
          ...
          Math.floor(0.8 * allInstructors[randomInstructorNumber].maxDefense);
        newObjToPush.hp =
          Math.floor(
            Math.random() *
              (allInstructors[randomInstructorNumber].maxHP -
                0.8 * allInstructors[randomInstructorNumber].maxHP)
          ) + Math.floor(0.8 * allInstructors[randomInstructorNumber].maxHP);
